export default function Tos() {
    return (
        <div className="max-w-4xl mx-auto p-8 text-on-surface bg-surface m-4 mr-2 mt-20 md:m-8 md:mr-4 h-auto rounded-lg shadow-lg">
            ...
            <div className="richtext break-words space-y-8">
                <section>
                    ...
                    <p className="text-lg leading-relaxed">By using Email Friends ("the Service"), you agree to these Terms of Service. If you disagree with any part of these terms, please do not use the Service.</p>
                </section>

                <section>
                    <h2 id="2-service-description" className="text-2xl font-semibold mb-4 text-primary">2. Service Description</h2>
                    <p className="text-lg mb-4">Email Friends is an email management service that:</p>
                ...
                <section>
                    ...
                    <p className="text-lg mb-4">We reserve the right to:</p>
                    <ul className="list-disc pl-6 space-y-2 text-lg">
                ...
                <section>
                    ...
                    <p className="text-lg mb-4">The Service is not liable for:</p>
                    <ul className="list-disc pl-6 space-y-2 text-lg">
                ...
                <section>
                    ...
                    <p className="text-lg mb-4">For questions about these terms:</p>
                    <ul className="list-disc pl-6 space-y-2 text-lg">
